...
/**
 * This class is the same as the LinkedHashSet except for the
 * behavior when accessed or an element is re-inserted in the list.
 * This this case the element <i>is</> reordered to the end
 * of the list.
 * 
 * Only other difference is this does not implement Serializeable,
 * and does not offer the spliterator method.
 *
...
public class AccessOrderHashSet<E>
